                      ...
                      children: <Widget>[
                        ...
                        Flexible(
                            ...
                            child: new Column(
                              ...
                              children: <Widget>[
                                new Text(widget.deviceObject.name.toString(), style: new TextStyle(fontSize: global.font16, color: Color(0xff121212), fontWeight: FontWeight.normal,fontFamily: 'MulishRegular')),
                                new Text(widget.deviceObject.uniqueid.toString(), style: new TextStyle(fontSize: global.font14, color: Color(0xff121212), fontWeight: FontWeight.normal,fontFamily: 'MulishRegular')),
